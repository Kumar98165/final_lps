    ...
    return (
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-slate-200/60 pb-10">
            <div className="space-y-4">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-black text-slate-900 uppercase tracking-tighter leading-none">
                        ADMIN<br /><span className="text-slate-300">PRODUCTION</span>
                    </h1>
                </div>
            ...
            <div className="flex items-center gap-4">
                <button className="flex items-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-400 text-[11px] font-black uppercase tracking-widest rounded-2xl hover:text-slate-900 hover:border-slate-900 transition-all shadow-sm group">
