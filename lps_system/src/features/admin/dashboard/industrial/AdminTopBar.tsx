            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-ind-border ml-2">
                    <div className="text-right">
                        <div className="text-[0.75rem] font-black text-ind-text leading-tight">Admin User</div>
                        <div className="text-[0.55rem] font-bold text-emerald-500 uppercase tracking-widest flex items-center justify-end gap-1">
