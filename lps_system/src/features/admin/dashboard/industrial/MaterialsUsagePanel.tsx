                ...
                <div className="flex gap-2">
                    {models.map(m => (
                        <button 
                            ...
                            className={`font-mono-jet text-[0.7rem] px-3 py-1 rounded-md transition-all border ${
                                activeModel === m 
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
                    {materials.map((m, i) => (
                        <div key={i} className="bg-ind-bg2/50 border border-ind-border rounded-xl p-3 text-center transition-all hover:border-ind-border2 group shadow-sm">
                            ...
                            <div className="h-1 bg-slate-100 rounded-full mt-2 overflow-hidden shadow-inner border border-slate-200">
                                <div 
